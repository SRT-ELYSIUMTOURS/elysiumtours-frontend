...
// Below header: 5 story image frames (frame47-51) arranged in a horizontal layout
...
// 5 story frames in a masonry-style horizontal layout
const STORIES = [
      ...
      <div className="px-[156px]">
        ...
        <div className="flex items-start justify-between w-full mb-[48px]">
          ...
          <div className="flex flex-col gap-[16px] items-end w-[597px]">
            ...
            <p className="font-raleway font-normal text-[16px] leading-[24px] text-tertiary-normal-default text-right w-[522px]">
        ...
        {/* 5 story frames — two rows: 3 tall + 2 short, or alternating heights */}
        <div className="flex gap-[20px] items-start">
          {/* Column arrangement: 3 items with alternating tall/short */}
          {/* Row 1: full width story (tall) */}
          <div className="flex gap-[20px] w-full">
            {STORIES.map((story, i) => (
              <div
                key={story.id}
                className={classNames(
                  "flex-1 relative overflow-hidden rounded-[20px] cursor-pointer group",
                  "transition-all duration-300 ease-in hover:shadow-xl",
                  // Alternating heights: tall-short-tall-short-tall
                  i % 2 === 0 ? "h-[480px]" : "h-[360px]"
                )}
              >
                {/* Background image */}
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-[20px]">
                  <p className="font-raleway font-semibold text-[16px] leading-[22px] text-primary-light-default line-clamp-2">
                    {story.title}
                  </p>
                </div>
              </div>
