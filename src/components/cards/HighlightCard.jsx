...
// Figma: tall image card with dark overlay and bold label — 451×656px default
// Used in: PartnerHighlightsSection (home), TourTypesSection (tours), PartnerCategorySection,
//          PartnerListingGrid, PartnerSpotlightPreview, BlogCategoryPage
      ...
      >
        ...
        <div className={labelClassName ?? defaultLabelClass}>
          {!labelClassName && (
            <div
              aria-hidden
              className="highlight-card-label-frost pointer-events-none absolute inset-0 rounded-b-[40px]"
            />
          )}
