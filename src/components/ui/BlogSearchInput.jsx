  ...
  return (
    ...
    >
      <input
        ...
        className="w-full h-full pl-[20px] pr-[50px] bg-transparent font-raleway font-medium text-med-small-Medium text-primary-dark-active placeholder:text-primary-dark-active outline-none"
      />
